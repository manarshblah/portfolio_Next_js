            ...
            <motion.div
                ...
                <div className='col-span-8 place-self-center text-center sm:text-left justify-self-start'>
                    ...
                    <p className='text-[#ADB7BE] text-base mb-6 sm:text-lg lg:text-xl'>
                        I'm manar shblah engineer and this is my Portfolio, thanks for your visit.
                    </p>
                    <div>
                        ...
                        <a href="/images/Manar_Sh.pdf" download="Manar_Sh.pdf">
                            <button className=' px-1 py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 hover:bg-slate-800 text-white mt-3'>
                                <span className='block bg-[#121212] hover:bg-slate-800 rounded-full px-10 py-3'>Download CV</span>
                            </button>
                        </a>
